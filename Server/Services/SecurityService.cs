...
namespace VideoOnDemandApi.Server.Services
{
    public class SecurityService : BaseService, ISecurityService
    {
        protected readonly IVideoOnDemandUow uow;
        protected readonly IEncryptionService encryptionService;
        protected readonly ICache cache;

        public SecurityService(IEncryptionService encryptionService, IVideoOnDemandUow uow, ICacheProvider cacheProvider)
            :base(cacheProvider)
        {
            this.uow = uow;
